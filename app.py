...
# GOOGLE_CLIENT_ID = "587354091035-rn858ec4ld9fnqr0nlva6rpq9l3utut0.apps.googleusercontent.com" # mero
...
app.config['MONGO_URI']="mongodb+srv://admin:admin@cluster0.qtw7vhy.mongodb.net/test"
